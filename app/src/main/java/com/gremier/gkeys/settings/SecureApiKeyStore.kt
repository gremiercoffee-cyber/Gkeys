...
object SecureApiKeyStore {
    ...
    fun getDeepgramKey(context: Context): String = readKey(context, KEY_DEEPGRAM)
    ...
    fun saveDeepgramKey(context: Context, key: String) = writeKey(context, KEY_DEEPGRAM, key)
